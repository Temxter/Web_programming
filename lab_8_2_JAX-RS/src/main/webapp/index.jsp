...
<a href="${pageContext.request.contextPath}/tests" style="text-align: center">Tests service</a> <br>
<a href="${pageContext.request.contextPath}/users" style="text-align: center">Users service</a>
