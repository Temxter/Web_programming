...
import controller.servlets.Servlet;
import model.Dao.*;
...
public class Command {
    ...
    private String editUser() {
        ...
        User user = daoUser.get(Integer.parseInt(id));
        ...
        servlet.log("[USER WAS: id = " + user.getId() + ", login = " + user.getLogin() +
                ", password = " + user.getPassword() + ", type = " + user.getUserType() +
                "] USER NEW: id = " + id + ", login = " + login +
                ", password = " + password + ", type = " + userTypeString);
